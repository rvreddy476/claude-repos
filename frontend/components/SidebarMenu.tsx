...
export const SidebarMenu: React.FC<SidebarMenuProps> = ({ currentUser }) => {
  return (
    <div className="h-full bg-white border-r border-gray-200 p-4">
      ...
      <nav className="space-y-2">
        <a
          href="#"
          className="flex items-center space-x-3 px-3 py-2 rounded-lg bg-blue-100 text-blue-700 font-medium"
        >
